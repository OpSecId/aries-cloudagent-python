...
from ..models import IssuanceOptions, DIProof, VerifiableCredential_V1
...
class VcLdpManager:
    ...
    async def prepare_credential(
        self,
        credential: VerifiableCredential_V1,
    ...
    async def _get_suite_for_document(
        self,
        document: Union[VerifiableCredential_V1, VerifiablePresentation],
        options: IssuanceOptions,
    ) -> LinkedDataProof:
        if isinstance(document, VerifiableCredential_V1):
    ...
    async def issue(
        self, credential: VerifiableCredential_V1, options: IssuanceOptions
    ) -> VerifiableCredential_V1:
        ...
        return VerifiableCredential_V1.deserialize(vc)

    async def store_credential(
        self, vc: VerifiableCredential_V1, options: IssuanceOptions, cred_id: str = None
    ) -> VerifiableCredential_V1:
    ...
    async def verify_credential(
        self, vc: VerifiableCredential_V1
