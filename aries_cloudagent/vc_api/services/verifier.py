...
from ..di_proofs.validation_result import DocumentVerificationResult
...
class VerifierService:
    ...
    async def _verify_di_proof(
        ...
        try:
            suite = CRYPTOSUITES[options.cryptosuite](self.profile)
        except:
    ...
    async def verify_presentation(
        ...
        if vp.verifiable_credential:
            credentials = (
                ...
                if isinstance(vp.verifiable_credential, dict)
                else vp.verifiable_credential
            )
