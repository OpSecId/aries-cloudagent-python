...
# from ...models import VerifiableCredentialBase
...
# from ...workflows.message_types import (
#     ATTACHMENT_FORMAT,
#     CRED_20_ISSUE,
#     CRED_20_OFFER,
#     CRED_20_PROPOSAL,
...
# class AnonCreds2023(V20CredFormatHandler):
...
#             records = await AnonCreds2023.format.detail.query_by_cred_ex_id(
#                 session, cred_ex_id
#             )
...
#         async with self.profile.session() as session:
#             exist = await AnonCreds2023.format.detail.query_by_cred_ex_id(
#                 session, cred_ex_id
#             )
#         if exist:
#             raise V20CredFormatError(
#                 f"{AnonCreds2023.format.api} detail record already "
...
#         """
#         return ATTACHMENT_FORMAT[message_type][AnonCreds2023.format.api]
...
#         return (
#             V20CredFormat(
#                 attach_id=AnonCreds2023.format.api,
#                 format_=self.get_format_identifier(message_type),
#             ),
#             AttachDecorator.data_base64(data, ident=AnonCreds2023.format.api),
#         )
...
#             **cred_proposal_message.attachment(AnonCreds2023.format)
#         )
...
#         credential = VerifiableCredentialBase(
#             issuer=public_did,
...
#         cred_offer = cred_ex_record.cred_offer.attachment(AnonCreds2023.format)
...
#         cred = cred_ex_record.cred_issue.attachment(AnonCreds2023.format)
...
#                 raise V20CredFormatError(
#                     f"No credential exchange {AnonCreds2023.format.aries} "
