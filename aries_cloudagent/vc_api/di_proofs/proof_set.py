    ...
    async def add(
        *,
        ...
        Args:
            ...
            suite (DataIntegrityProof): A signature suite instance that will create the proof
    ...
    async def verify(
        *,
        ...
        Args:
            ...
            suites (List[DataIntegrityProof]): Acceptable signature suite instances
    ...
    async def derive(
        *,
        ...
        Args:
            ...
            suite (DataIntegrityProof): A signature suite instance to derive the proof.
            document_loader (DocumentLoader): Document loader to use.
