...
async def sign(
    *,
    ...
    Args:
        ...
        suite (DataIntegrityProof): The linked data signature cryptographic suite
    ...
    Raises:
        DataIntegrityProofException: When a jsonld url cannot be resolved, OR signing fails.
...
async def verify(
    *,
    document: dict,
    suites: List[DataIntegrityProof],
    purpose: ProofPurpose,
    document_loader: DocumentLoaderMethod,
    ...
    Args:
        ...
        suites (List[DataIntegrityProof]): Acceptable signature suite instances for
